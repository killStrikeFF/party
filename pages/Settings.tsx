...
export const Settings = ({
    ...
    const saveUserInfo = () => {
        userStorage.updateUserInfo({name: newUserName, image: newUserImage, color: newUserColor}).then((res) => {
    ...
    const ColorBadge = ({color, selected}: { color: string, selected: boolean }) => {
                ...
                <View style={styles.profileCardRow}>
                    {borderColors.map(color => (
                        <TouchableOpacity onPress={() => setNewUserColor(color)}>
                            <ColorBadge color={color} selected={color === newUserColor} key={color}/>
                        </TouchableOpacity>
                    ))}
                </View>
            </View>
